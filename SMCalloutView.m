...
#define CALLOUT_DEFAULT_CONTAINER_HEIGHT 10 // height of just the main portion without arrow
#define CALLOUT_SUB_DEFAULT_CONTAINER_HEIGHT 10 // height of just the main portion without arrow (when subtitle is present)
...
#define TOP_ANCHOR_MARGIN 0 // all the above measurements assume a bottom anchor! if we're pointing "up" we'll need to add this top margin to everything.
#define COMFORTABLE_MARGIN 0 // when we try to reposition content to be visible, we'll consider this margin around your target rect
...
- (id)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.contentViewInset = UIEdgeInsetsMake(0, 0, -1, 0);
